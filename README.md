...
LIBRARY  | Get By ID              | GET    | /libraries/{id}                  |                                                                                                   | Finds a library by the given user ID, if it exists.
...
USER     | Post User              | POST   | /users                           | REQUIRED: dto (UserDtoCreate)                                                                     | Uploads a user to the database and creates their corresponding wishlist and library.
